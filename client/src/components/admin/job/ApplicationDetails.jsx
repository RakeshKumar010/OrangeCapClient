      ...
      <div className="w-[70vw] max-w-[800px] bg-white rounded-lg shadow-2xl p-8">
        ...
        <div className="text-center mb-6">
          <h2 className="text-3xl font-semibold text-gray-800">
            Application Details {console.log(selectedUser)}
          </h2>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 text-gray-700">
          {[
            ...
            { icon: FiCalendar, label: "position", value: position },
            {
                icon: FiMessageSquare,
                label: "Experience",
                value: experience,
              },
            { icon: FiClock, label: "Current Location", value: currentLocation },
           
            { icon: LuMapPinned, label: "Linkedin", value: linkedin },
            { icon: IoLocationOutline, label: "Portfolio", value: portfolio },
            { icon: IoLocationOutline, label: "Cover Letter", value: coverLetter },
            { icon: IoLocationOutline, label: "Resume", value: resume },
            { icon: IoLocationOutline, label: "Added Time", value: addedTime },
