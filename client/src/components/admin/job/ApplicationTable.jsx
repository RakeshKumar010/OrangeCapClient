...
const ApplicationTable = ({ searchValue }) => {
  ...
  const handleAllSelect = ({ searchValue }) => {
  ...
  const downloadExcal = () => {
    ...
    XLSX.writeFile(wb, "applicationData.xlsx");
  };
  ...
  const handleDelete = () => {
    Swal.fire({
      ...
      if (result.isConfirmed) {
        try {
          const response = await fetch(baseUrl + "/select-application-delete", {
            method: "DELETE",
            headers: {
  ...
  useEffect(() => {
    const getFun = async () => {
      try {
        let result = await fetch(baseUrl + "/application");
                    ...
                    return (
                      <>
                        ...
                        >
                          ...
                          >
                            {value.firstName ? value.firstName : "no name"}
                          </th>
                          ...
                          <td className="px-6 py-4 text-center">
                            {value.position ? value.position : "no value"}
                          </td>
                          <td className="px-6 py-4 text-center">
